...
export const selectTotalProjects = (state: RootState) => selectDashboardData(state)?.totalProjects ?? initialData.totalProjects;
export const selectTotalIssues = (state: RootState) => selectDashboardData(state)?.totalIssues ?? initialData.totalIssues;
export const selectissueAll = (state: RootState) => selectDashboardData(state)?.allIssues ?? initialData.allIssues;
export const selectIssueAssignTo = (state: RootState) => selectDashboardData(state)?.allAssignTo ?? initialData.allAssignTo;
